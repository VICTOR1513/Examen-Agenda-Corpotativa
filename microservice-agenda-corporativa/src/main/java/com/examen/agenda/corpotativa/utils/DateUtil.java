...
public class DateUtil {
	...
	private static final String FFORMAT_YYYYYMMDDHHMM = "yyyy-MM-dd'T'HH:mm";
...
//    }
	...
	public static Date dateFronDateTimeString(String fecha) {
		try {
			SimpleDateFormat format = new SimpleDateFormat(FFORMAT_YYYYYMMDDHHMM);
	...
	public static String dateFronDateTimeDate(Date fecha) {
		try {
			Format formatter = new SimpleDateFormat(FFORMAT_YYYYYMMDDHHMM);
			return formatter.format(fecha);
		} catch (Exception e) {
			log.error("Error: " + ExceptionUtils.getStackTrace(e));
		}
